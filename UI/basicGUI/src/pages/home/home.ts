...
export class HomePage {
  ...
  setBlock() {
    ...
    if (this.waldo){
      this.map.removeLayer(this.waldo);
    }
    this.waldo = leaflet.marker([this.tmp.lat, this.tmp.lng]);
    markerGroup.addLayer(this.waldo);
    this.map.addLayer(markerGroup);
    console.log("You clicked the map at latitude: " + this.tmp.lat + " and longitude: " + this.tmp.lng);
    });
